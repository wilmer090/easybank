...
import "../assets/styles/DesktopFooter.css";
const DesktopFooter = () => {
  return (
    <section className="desktop-footer_wrapper center-text">
      <div className="content-size-25" style={{ textAlign: "left" }}>
      ...
      <div className="content-size-25 footer_menu">
        <ul>
          <li>About Us</li>
          <li>Contact</li>
          <li>Blog</li>
      ...
      <div className="container-3 content-size-50">
        <div>
